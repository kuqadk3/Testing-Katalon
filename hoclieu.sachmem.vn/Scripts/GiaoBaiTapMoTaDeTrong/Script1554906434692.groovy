...
WebUI.setText(findTestObject('Page_Hc liu - Sch Mm/input_M t_form-control ng-untouched ng-pristine ng-valid'), '')

WebUI.click(findTestObject('Page_Hc liu - Sch Mm/GiaoBaiTap'))

WebUI.verifyElementPresent(findTestObject('Page_Hc liu - Sch Mm/div_Giao bi tp thnh cng'), 2)
